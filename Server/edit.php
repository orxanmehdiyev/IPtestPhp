	...
	<form method="POST" action="Server/editislem.php">	
		<?php 
		if (isset($_GET['ip'])) {	
			...
			<div  class="editkapsayici">
				...
				<div class="editsetiralani">
					<label class="editlabel">Tipi:</label>
					<select class="editinput" name="Teyinati">
						<option <?php echo ($Cek['Teyinati']=="Teyinati")?"selected":"";?> value="Fiziki">Fiziki</option>;
						<option <?php echo ($Cek['Teyinati']=="Virtual")?"selected":"";?> value="Virtual">Virtual</option>;
					</select>
				</div>
				...
				<div class="editsetiralani">
					<label class="editlabel">İstifadəçi Adı:</label>
