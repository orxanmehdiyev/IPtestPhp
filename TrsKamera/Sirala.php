...
if (isset($_POST['sirala'])) {
	...
	if ($_POST['sirala']=="IpNoktesiz") {
		if (@$_SESSION['Sirala'] == "IpNoktesiz ASC") {
			$_SESSION['Sirala'] = "IpNoktesiz DESC";
		}else{
			$_SESSION['Sirala'] = "IpNoktesiz ASC";
		}	
		$Sirala=$_SESSION['Sirala'];
	}elseif($_POST['sirala']=="StatusSirala"){
		if ($_SESSION['Sirala'] == "Status ASC") {
			$_SESSION['Sirala'] = "Status DESC";
		}else{
			$_SESSION['Sirala'] = "Status ASC";
		}	
		$Sirala=$_SESSION['Sirala'];
	}elseif($_POST['sirala']=="SonCavabTarixiSirala"){
		if ($_SESSION['Sirala'] == "SonCavabTarixi ASC") {
			$_SESSION['Sirala'] = "SonCavabTarixi DESC";
		}else{
			$_SESSION['Sirala'] = "SonCavabTarixi ASC";
		}	
		$Sirala=$_SESSION['Sirala'];
	}elseif($_POST['sirala']=="IstifadeyeVerildiyiTarix"){
		if ($_SESSION['Sirala'] == "IstifadeyeVerildiyiTarix ASC") {
			$_SESSION['Sirala'] = "IstifadeyeVerildiyiTarix DESC";
		}else{
			$_SESSION['Sirala'] = "IstifadeyeVerildiyiTarix ASC";
		}	
		$Sirala=$_SESSION['Sirala'];
	}	else{
