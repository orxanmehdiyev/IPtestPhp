...
if (isset($_POST['yelile'])) {
	...
	$IstifadeyeVerildiyiTarix        =  (ReqemlerXaricButunKarakterleriSil($_POST['IstifadeyeVerildiyiTarix'])>0)?$_POST['DiskHecmi']:NULL;
	$Qeyd                            =  $_POST['Qeyd'];
	...
	if ($update) {
		header("Location:../tibbo.php?edtip=$ip&durum=ok");
	}else{
		header("Location:../tibbo.php?ip=$ip&durum=no");
	}
}
?>